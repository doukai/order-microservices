...
public @interface ProductExpressionBase1 {
  /**
   * 产品ID
   */
  @Description("产品ID")
   ...
   */
  @Description("评论列表")
  ReviewExpression2 reviews() default @ReviewExpression2;
  ...
  ProductReviewRelationExpression2 productReviewRelation(
      ) default @ProductReviewRelationExpression2;

...
public interface ReviewUserRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  StringExpression reviewRef = null;
  ...
  Collection<ReviewUserRelationExpression> exs = null;
  ...
  default StringExpression getReviewRef() {
    return reviewRef;
  }

  void setReviewRef(StringExpression reviewRef);
  ...
  default Collection<ReviewUserRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<ReviewUserRelationExpression> exs);
}

...
public interface OrderItemProductRelationExpressionBase extends MetaExpression {
  /**
   * ID
   */
  @Description("ID")
  ...
  Collection<OrderItemProductRelationExpression> exs = null;
  ...
  default Collection<OrderItemProductRelationExpression> getExs() {
    return exs;
  }

  void setExs(Collection<OrderItemProductRelationExpression> exs);
}

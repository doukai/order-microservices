...
/**
 * Mutation Arguments for Relationship Object between 评论 and 用户
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Mutation Arguments for Relationship Object between 评论 and 用户")
public class ReviewUserRelationMutationArguments implements MetaInput, ReviewUserRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Input")
  private ReviewUserRelationInput input;
  ...
  public ReviewUserRelationInput getInput() {
    return this.input;
  }

  public void setInput(ReviewUserRelationInput input) {
    this.input = input;
  }

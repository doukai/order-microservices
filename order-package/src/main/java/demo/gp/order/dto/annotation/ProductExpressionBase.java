...
import demo.gp.review.dto.annotation.ReviewExpression1;
...
public @interface ProductExpressionBase {
  /**
   * 产品ID
   */
  @Description("产品ID")
   ...
   */
  @Description("评论列表")
  ReviewExpression1 reviews() default @ReviewExpression1;
  ...
  ProductReviewRelationExpression1 productReviewRelation(
      ) default @ProductReviewRelationExpression1;

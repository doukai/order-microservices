...
/**
 * Subscription Arguments for Relationship Object between 订单 and 订单项 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for Relationship Object between 订单 and 订单项 List")
public class OrderOrderItemRelationConnectionSubscriptionArguments implements MetaExpression, OrderOrderItemRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")
  ...
  private OrderOrderItemRelationOrderBy orderBy;
  ...
  public OrderOrderItemRelationOrderBy getOrderBy() {
    return this.orderBy;
  }

  public void setOrderBy(OrderOrderItemRelationOrderBy orderBy) {

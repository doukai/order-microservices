...
/**
 * Query Arguments for Relationship Object between 订单 and 订单项 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 订单 and 订单项 List")
public class OrderOrderItemRelationListQueryArguments implements MetaExpression, OrderOrderItemRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")

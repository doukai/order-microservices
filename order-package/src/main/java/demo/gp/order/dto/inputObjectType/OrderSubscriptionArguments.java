...
/**
 * Subscription Arguments for 订单
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for 订单")
public class OrderSubscriptionArguments implements MetaExpression, OrderExpressionBase {
  /**
   * 订单ID
   */
  @Description("订单ID")

...
/**
 * Query Arguments for Relationship Object between 订单 and 订单项 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 订单 and 订单项 Connection")
public class OrderOrderItemRelationConnectionQueryArguments implements MetaExpression, OrderOrderItemRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")

...
/**
 * Mutation Arguments for Relationship Object between 产品 and 评论
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Mutation Arguments for Relationship Object between 产品 and 评论")
public class ProductReviewRelationMutationArguments implements MetaInput, ProductReviewRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
   ...
   */
  @Description("Input")
  private ProductReviewRelationInput input;
  ...
  public ProductReviewRelationInput getInput() {
    return this.input;
  }

  public void setInput(ProductReviewRelationInput input) {
    this.input = input;
  }

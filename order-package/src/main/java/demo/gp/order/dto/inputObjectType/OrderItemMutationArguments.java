...
/**
 * Mutation Arguments for 订单项
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Mutation Arguments for 订单项")
public class OrderItemMutationArguments implements MetaInput, OrderItemInputBase {
  /**
   * 订单项ID
   */
  @Description("订单项ID")
  ...
  public OrderItemInput getInput() {
    return this.input;
  }

  public void setInput(OrderItemInput input) {
    this.input = input;
  }

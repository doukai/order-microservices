...
public @interface ReviewUserRelationConnectionSubscriptionArguments {
  /**
   * ID
   */
  @Description("ID")
  ...
  ReviewUserRelationOrderBy orderBy() default @ReviewUserRelationOrderBy;
  ...
  ReviewUserRelationExpression[] exs() default {};

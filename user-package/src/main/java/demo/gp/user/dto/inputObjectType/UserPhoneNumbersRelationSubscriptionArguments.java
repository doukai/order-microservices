...
/**
 * Subscription Arguments for Relationship Object between 用户 and 联系方式
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for Relationship Object between 用户 and 联系方式")
public class UserPhoneNumbersRelationSubscriptionArguments implements MetaExpression, UserPhoneNumbersRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")

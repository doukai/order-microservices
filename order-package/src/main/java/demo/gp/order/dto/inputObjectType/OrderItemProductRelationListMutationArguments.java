...
public class OrderItemProductRelationListMutationArguments implements MetaInput, OrderItemProductRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
  ...
  private Collection<OrderItemProductRelationInput> list;
  ...
  public Collection<OrderItemProductRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<OrderItemProductRelationInput> list) {
    this.list = list;
  }

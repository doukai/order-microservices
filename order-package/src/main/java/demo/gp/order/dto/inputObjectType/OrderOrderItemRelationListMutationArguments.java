...
/**
 * Mutation Arguments for Relationship Object between 订单 and 订单项 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Mutation Arguments for Relationship Object between 订单 and 订单项 List")
public class OrderOrderItemRelationListMutationArguments implements MetaInput, OrderOrderItemRelationInputBase {
  /**
   * ID
   */
  @Description("ID")
  ...
  private Collection<OrderOrderItemRelationInput> list;
  ...
  public Collection<OrderOrderItemRelationInput> getList() {
    return this.list;
  }

  public void setList(Collection<OrderOrderItemRelationInput> list) {
    this.list = list;
  }

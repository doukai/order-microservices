...
/**
 * Query Arguments for Relationship Object between 订单 and 用户 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 订单 and 用户 List")
public class OrderUserRelationListQueryArguments implements MetaExpression, OrderUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")

...
public interface OrderOrderItemRelationInputBase extends MetaInput {
  /**
   * ID
   */
  @Description("ID")
  ...
  String __typename = "OrderOrderItemRelation";

  /**
   * Where
   */
  @Description("Where")
  OrderOrderItemRelationExpression where = null;
  ...
  default OrderOrderItemRelationExpression getWhere() {
    return where;
  }

  void setWhere(OrderOrderItemRelationExpression where);
}

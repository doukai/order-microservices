...
/**
 * Subscription Arguments for 订单项
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for 订单项")
public class OrderItemSubscriptionArguments implements MetaExpression, OrderItemExpressionBase {
  /**
   * 订单项ID
   */
  @Description("订单项ID")

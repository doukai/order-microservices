...
/**
 * Query Arguments for Relationship Object between 用户 and 联系方式 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for Relationship Object between 用户 and 联系方式 Connection")
public class UserPhoneNumbersRelationConnectionQueryArguments implements MetaExpression, UserPhoneNumbersRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")

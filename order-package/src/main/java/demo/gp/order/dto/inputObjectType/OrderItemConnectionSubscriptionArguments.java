...
/**
 * Subscription Arguments for 订单项 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for 订单项 List")
public class OrderItemConnectionSubscriptionArguments implements MetaExpression, OrderItemExpressionBase {
  /**
   * 订单项ID
   */
  @Description("订单项ID")

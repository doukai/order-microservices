...
public @interface UserOrderBy {
  ...
  UserPhoneNumbersRelationOrderBy1 userPhoneNumbersRelation(
      ) default @UserPhoneNumbersRelationOrderBy1;
  ...
  UserPhoneNumbersRelationOrderBy1 userPhoneNumbersRelationAggregate(
      ) default @UserPhoneNumbersRelationOrderBy1;

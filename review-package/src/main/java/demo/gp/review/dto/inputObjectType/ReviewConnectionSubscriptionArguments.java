...
/**
 * Subscription Arguments for 评论 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for 评论 List")
public class ReviewConnectionSubscriptionArguments implements MetaExpression, ReviewExpressionBase {
  /**
   * 评论ID
   */
  @Description("评论ID")

...
public @interface OrderOrderBy {
   ...
   */
  @Description("产品列表")
  OrderItemOrderBy1 items() default @OrderItemOrderBy1;
  ...
  OrderUserRelationOrderBy1 orderUserRelation() default @OrderUserRelationOrderBy1;

  /**
   * Relationship Object between 订单 and 订单项
   */
  @Description("Relationship Object between 订单 and 订单项")
  OrderOrderItemRelationOrderBy1 orderOrderItemRelation() default @OrderOrderItemRelationOrderBy1;

  /**
   * Aggregate Field for 产品列表
   */
  @Description("Aggregate Field for 产品列表")
  OrderItemOrderBy1 itemsAggregate() default @OrderItemOrderBy1;
  ...
  OrderOrderItemRelationOrderBy1 orderOrderItemRelationAggregate(
      ) default @OrderOrderItemRelationOrderBy1;

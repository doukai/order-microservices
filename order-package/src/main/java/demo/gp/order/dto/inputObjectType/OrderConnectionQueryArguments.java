...
/**
 * Query Arguments for 订单 Connection
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for 订单 Connection")
public class OrderConnectionQueryArguments implements MetaExpression, OrderExpressionBase {
  /**
   * 订单ID
   */
  @Description("订单ID")

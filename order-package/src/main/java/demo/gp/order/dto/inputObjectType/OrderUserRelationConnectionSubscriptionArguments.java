...
/**
 * Subscription Arguments for Relationship Object between 订单 and 用户 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Subscription Arguments for Relationship Object between 订单 and 用户 List")
public class OrderUserRelationConnectionSubscriptionArguments implements MetaExpression, OrderUserRelationExpressionBase {
  /**
   * ID
   */
  @Description("ID")

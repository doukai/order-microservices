...
/**
 * Query Arguments for 订单项 List
 */
@CompiledJson
@Input
@Generated("io.graphoenix.java.builder.TypeSpecBuilder_Proxy")
@Description("Query Arguments for 订单项 List")
public class OrderItemListQueryArguments implements MetaExpression, OrderItemExpressionBase {
  /**
   * 订单项ID
   */
  @Description("订单项ID")

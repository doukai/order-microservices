...
public @interface ReviewExpressionBase1 {
  /**
   * 评论ID
   */
  @Description("评论ID")
  ...
  ReviewUserRelationExpression2 reviewUserRelation() default @ReviewUserRelationExpression2;

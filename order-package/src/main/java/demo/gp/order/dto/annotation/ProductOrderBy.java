...
import demo.gp.review.dto.annotation.ReviewOrderBy1;
...
public @interface ProductOrderBy {
   ...
   */
  @Description("评论列表")
  ReviewOrderBy1 reviews() default @ReviewOrderBy1;
  ...
  ProductReviewRelationOrderBy1 productReviewRelation() default @ProductReviewRelationOrderBy1;

...
public @interface OrderItemOrderBy1 {
  ...
  OrderItemProductRelationOrderBy2 orderItemProductRelation(
      ) default @OrderItemProductRelationOrderBy2;
  ...
  OrderItemProductRelationOrderBy2 orderItemProductRelationAggregate(
      ) default @OrderItemProductRelationOrderBy2;
